        ...
        <div class="col-md-12">
            <div class="card second-color">
                <div class="card-header first-color">
                    <h4 class="custom-heading">Add Service</h4>
                </div>
                    ...
                    <form action="code_service.php" method="POST">
                        <div class="col-md-12">
                            <div class="row mb-3">
                                ...
                                <input type="text" name="particulars" id="particulars" placeholder="Enter Particulars" class="form-control">
                            </div>
                            <div class="row mb-3">
                                <label for="status" class="form-label">Status</label>
                                <select name="status" id="status" class="form-control">
                                    <option value="COMPLETED">COMPLETED</option>
                                    <option value="UNDER PROCESS">UNDER PROCCESS</option>
                                    <option value="YET TO START">YET TO START</option>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary mt-4 w-100" name="add_service_btn">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
