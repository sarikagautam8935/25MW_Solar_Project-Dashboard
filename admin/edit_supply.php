    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if (isset($_GET['id'])) {
                ...
                $supply = getByID("supply", $id);

                if (mysqli_num_rows($supply) > 0) {
                    $data = mysqli_fetch_array($supply);
                    ?>
                    <div class="card second-color">
                        <div class="card-header first-color">
                            <h4 class="custom-heading">Edit Supply</h4>
                        </div>
                        <div class="card-body third-color">
                            <form action="code_supply.php" method="POST">
                                <input type="hidden" name="supply_id" value="<?= $data['id'] ?>">
                                <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary mt-4 w-100" name="update_supply_btn">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
