        ...
        <div class="col-md-12">
            <div class="card second-color">
                <div class="card-header first-color">
                    <h4 class="custom-heading">Service Timeline</h4>
                </div>
                <div class="card-body third-color">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped custom-table">
                            ...
                            <tbody>
                                <?php
                                $service = getAll("service"); // Ensure this function returns data correctly
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_service.php?id=<?= htmlspecialchars($item['id']); ?>" class="btn btn-sm btn-primary">Edit</a>
                                                <form action="code_service.php" method="POST" style="display:inline;">
                                                    <input type="hidden" name="service_id" value="<?= htmlspecialchars($item['id']); ?>">
